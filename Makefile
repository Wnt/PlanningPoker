...
OBJECTS       = obj/harbour-planningpoker.o
DIST          = /usr/share/qt5/mkspecs/features/spec_pre.prf \
		...
		harbour-planningpoker.pro \
		harbour-planningpoker.pro
QMAKE_TARGET  = harbour-planningpoker
...
Makefile: harbour-planningpoker.pro /usr/share/qt5/mkspecs/linux-g++-32/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d obj/harbour-planningpoker1.0.0 || mkdir -p obj/harbour-planningpoker1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/harbour-planningpoker1.0.0/ && $(COPY_FILE) --parents src/harbour-planningpoker.cpp obj/harbour-planningpoker1.0.0/ && (cd `dirname obj/harbour-planningpoker1.0.0` && $(TAR) harbour-planningpoker1.0.0.tar harbour-planningpoker1.0.0 && $(COMPRESS) harbour-planningpoker1.0.0.tar) && $(MOVE) `dirname obj/harbour-planningpoker1.0.0`/harbour-planningpoker1.0.0.tar.gz . && $(DEL_FILE) -r obj/harbour-planningpoker1.0.0
...
obj/harbour-planningpoker.o: src/harbour-planningpoker.cpp /usr/include/qt5/QtQuick/QtQuick \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/harbour-planningpoker.o src/harbour-planningpoker.cpp
...
install_icon: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/sailfish_ws/harbour-planningpoker/harbour-planningpoker.png $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/harbour-planningpoker.png
...
install_desktop: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/sailfish_ws/harbour-planningpoker/harbour-planningpoker.desktop $(INSTALL_ROOT)/usr/share/applications/

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/harbour-planningpoker.desktop
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/applications/ 


install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/harbour-planningpoker || mkdir -p $(INSTALL_ROOT)/usr/share/harbour-planningpoker
	-$(INSTALL_DIR) /home/mersdk/sailfish_ws/harbour-planningpoker/qml $(INSTALL_ROOT)/usr/share/harbour-planningpoker/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/harbour-planningpoker/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/harbour-planningpoker/ 
